...
#                        define SD(val, pdst)                                  \
                            {                                                  \
                                ...
                                uint32_t val0_m, val1_m;                       \
                                                                               \
                                val0_m =                                       \
                                    (uint32_t)((val) & 0x00000000FFFFFFFF);    \
                                val1_m = (uint32_t)(((val) >> 32)              \
                                                    & 0x00000000FFFFFFFF);     \
                                                                               \
                                SW(val0_m, pdst_sd_m);                         \
...
#            define ADD4(in0, in1, in2, in3, in4, in5, in6, in7, out0, out1,   \
                         out2, out3)                                           \
                {                                                              \
                    ADD2(in0, in1, in2, in3, out0, out1);                      \
...
#            define SLDI_B2_0(RTYPE, in0, in1, out0, out1, slide_val)          \
                {                                                              \
                    v16i8 zero_m = { 0 };                                      \
                    out0 = (RTYPE)__msa_sldi_b((v16i8)zero_m, (v16i8)in0,      \
                                               slide_val);                     \
                    out1 = (RTYPE)__msa_sldi_b((v16i8)zero_m, (v16i8)in1,      \
                                               slide_val);                     \
                }
#            define SLDI_B2_0_UB(...) SLDI_B2_0(v16u8, __VA_ARGS__)

#            define SLDI_B3_0(RTYPE, in0, in1, in2, out0, out1, out2,          \
                              slide_val)                                       \
                {                                                              \
                    v16i8 zero_m = { 0 };                                      \
                    SLDI_B2_0(RTYPE, in0, in1, out0, out1, slide_val);         \
                    out2 = (RTYPE)__msa_sldi_b((v16i8)zero_m, (v16i8)in2,      \
                                               slide_val);                     \
                }
...
#            define VSHF_B2(RTYPE, in0, in1, in2, in3, mask0, mask1, out0,     \
                            out1)                                              \
                {                                                              \
                    out0 = (RTYPE)__msa_vshf_b((v16i8)mask0, (v16i8)in1,       \
                                               (v16i8)in0);                    \
                    out1 = (RTYPE)__msa_vshf_b((v16i8)mask1, (v16i8)in3,       \
                                               (v16i8)in2);                    \
                }
...
#            define CMP_AND_SELECT(inp0, inp1, inp2, inp3, inp4, inp5, out0)   \
                {                                                              \
                    ...
                    _sel_b0 =                                                  \
                        (v16u8)__msa_pckev_b((v16i8)_sel_h0, (v16i8)_sel_h0);  \
                    inp0 = (v8i16)__msa_bmnz_v((v16u8)inp0, (v16u8)inp1,       \
                                               (v16u8)_sel_h0);                \
                    inp4 = (v16u8)__msa_bmnz_v(inp3, inp4, _sel_b0);           \
                    _sel_h1 = (v8i16)__msa_clt_u_h((v8u16)inp2, (v8u16)inp0);  \
                    _sel_b1 =                                                  \
                        (v16u8)__msa_pckev_b((v16i8)_sel_h1, (v16i8)_sel_h1);  \
    ...
    if (istop & 0x3F)
    {
        ...
        if (cnt32)
        {
            if (cnt16 && cnt)
            {
                ...
                ADD4(src0, src4, src1, src5, src2, src6, src3, src7, src0, src1,
                     src2, src3);
                                  ...
                                  png_const_bytep prev_row)
{
    ...
    v16u8 src0, src1, src2, src3, src4, src5, src6, src7, src8, src9, dst0,
        dst1;
    v16u8 zero = { 0 };
