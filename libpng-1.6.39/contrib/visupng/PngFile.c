...
#    endif
        ...
        {
            png_set_background(png_ptr, pBackground, PNG_BACKGROUND_GAMMA_FILE,
                               1, 1.0);
        ...
        *piChannels = ulChannels;
        ...
        if ((*piHeight) > ((size_t)(-1)) / ulRowBytes)
        {
            ...
            *ppbImageData = pbImageData;
            ...
            if ((ppbRowPointers =
                     (png_bytepp)malloc((*piHeight) * sizeof(png_bytep)))
                == NULL)
            {
                png_error(png_ptr, "Visual PNG: out of memory");
            }
                      ...
                      int iHeight, png_color bkgColor)
    {
        ...
        Try
        {
            ...
            if ((ppbRowPointers =
                     (png_bytepp)malloc(iHeight * sizeof(png_bytep)))
                == NULL)
