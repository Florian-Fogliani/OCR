                   ...
                   int iCmdShow)
{
    ...
    hwnd =
        CreateWindow(szProgName, szAppName, WS_OVERLAPPEDWINDOW, CW_USEDEFAULT,
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
        ...
        if (pDib)
            SetDIBitsToDevice(hdc, 0, 0, cxWinSize, cyWinSize, 0, 0, 0,
                              cyWinSize, pDiData, (BITMAPINFO *)pDib,
                              DIB_RGB_COLORS);
                  ...
                  int cImgChannels, BOOL bStretched)
{
    ...
    if (cyWinSize > ((size_t)(-1)) / wDIRowBytes)
    {
        ...
        *ppDiData = pDiData;
        ...
        if (pbImage)
        {
            FillBitmap(pDiData, cxWinSize, cyWinSize, pbImage, cxImgSize,
                       cyImgSize, cImgChannels, bStretched);
        }
                    ...
                    BOOL bStretched)
    {
        ...
        if (bStretched)
        {
            ...
            MessageBox (hwnd, TEXT ("Visual PNG: stretched image is too big");
                ...
                for (yNew = 0; yNew < cyNewSize; yNew++)
                {
                    ...
                    for (xNew = 0; xNew < cxNewSize; xNew++)
                    {
                        ...
                        r = *(pbImage
                              + cImgChannels * ((yOld * cxImgSize) + xOld) + 0);
                        g = *(pbImage
                              + cImgChannels * ((yOld * cxImgSize) + xOld) + 1);
                        b = *(pbImage
                              + cImgChannels * ((yOld * cxImgSize) + xOld) + 2);
                        *pImg++ = r;
                        *pImg++ = g;
                        *pImg++ = b;
                        if (cImgChannels == 4)
                        {
                            a = *(pbImage
                                  + cImgChannels * ((yOld * cxImgSize) + xOld)
                                  + 3);
                            *pImg++ = a;
                        }
                    }
                ...
                for (yImg = 0, yWin = cyImgPos; yImg < cyNewSize;
                     yImg++, yWin++)
                {
                    ...
                    for (xImg = 0, xWin = cxImgPos; xImg < cxNewSize;
                         xImg++, xWin++)
                    {
            ...
            else
            {
                ...
                for (yImg = 0, yWin = cyImgPos; yImg < cyImgSize;
                     yImg++, yWin++)
                {
                    ...
                    for (xImg = 0, xWin = cxImgPos; xImg < cxImgSize;
                         xImg++, xWin++)
                    {
