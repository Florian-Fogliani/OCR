...
png_do_check_palette_indexes(png_structrp png_ptr, png_row_infop row_info)
{
        ...
        && png_ptr->num_palette > 0) /* num_palette can be 0 in MNG files */
    {
         ...
         * compiler warnings.  'padding' is in *bits* within the last byte, it
         * is an 'int' because pixel_depth becomes an 'int' in the expression
         * below, and this calculation is used because it avoids warnings that
         * other forms produced on either GCC or MSVC.
         */
